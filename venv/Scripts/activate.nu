...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\InnovateHub\Sport News\Retail-Data-Warehouse-Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\InnovateHub\Sport News\Retail-Data-Warehouse-Project\venv\Scripts\deactivate.nu'
